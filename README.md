...
<p align="justify">He trabajado en varios proyectos y roles, desde soporte técnico a equipos de computación y capacitación a usuario, pasando por clases y tutorías universitarias, hasta desarrollar aplicaciones de gestión, administración y sitios web. Algunos de mis logros incluyen:</p>

**🌵 Desarrollador de Aplicaciones – IMV**

- Desarrollo, mantenimiento y soporte de aplicaciones internas para procesos operativos y administrativos
- Implementación de sistemas web para gestión de pacientes, acceso a servicios, administración y reportes estadísticos
- Desarrollo de herramientas internas para optimización de procesos y monitoreo
- Diseño e implementación de integraciones entre sistemas _legacy_ y plataformas web modernas
- Participación activa en tareas de _DevOps:_ administración de servidores Linux, migración de bases de datos, automatización y respaldos
- Soporte técnico, levantamiento de requerimientos con usuarios finales y documentación técnica

**🌵 Líder de Equipo – Sistema de Gestión Bibliotecaria**

- Diseño y desarrollo de un software de gestión bibliotecaria
- Uso de entornos GNU/Linux y software de código abierto
- Coordinación de tareas, organización del trabajo
- Apoyo técnico a los integrantes del equipo

**🌵 Desarrollador de Aplicaciones –  Academia Wanda**

- Implementación de aplicación web con Node.js
- Administración de Base de Datos y Cifrado de la misma
- Desarrollo y adaptabilidad de UI/UX personalizado
- Escaneo y Monitoreo continuo de la Red Privada

**🌵 Tutor Universitario –  Autónomo**

- Introducción a la programación, nociones básicas y fundamentos
- Enseñanza de técnicas avanzadas de programación
- Orientación en métodos de estudio e investigación
- Contribución a la formación de profesionales de alto rendimiento

**🌵 Líder de Equipo – Soporte Técnico y Capacitación**

- Soporte técnico a equipos de computación y capacitación a usuarios
- Utilización de metodologías del marco lógico y cuantitativa
- Recolección de datos mediante encuestas y cuestionarios
- Plan de mantenimiento preventivo y correctivo para equipos de computación
- Talleres para usuarios sobre mantenimiento de equipos de computación

## 🔧 Competencias Digitales

| Categoría | Tecnologías y Herramientas |
| :--- | :--- |
| **Frontend & Backend** | ![#HTML](https://img.shields.io/badge/HTML5-E34F26?logo=html5&logoColor=white&style=flat-square) ![#CSS](https://img.shields.io/badge/CSS3-1572B6?logo=CSS&logoColor=white&style=flat-square) ![#JS](https://img.shields.io/badge/JavaScript-F7DF1E?logo=javascript&logoColor=black&style=flat-square) ![#Python](https://img.shields.io/badge/Python-3776AB?logo=python&logoColor=white&style=flat-square) ![#Node](https://img.shields.io/badge/Node.js-339933?logo=nodedotjs&logoColor=white&style=flat-square) ![#PHP](https://img.shields.io/badge/PHP-777BB4?logo=php&logoColor=white&style=flat-square) ![#C](https://img.shields.io/badge/C-A8B9CC?logo=c&logoColor=white&style=flat-square) |
| **Databases & Ops** | ![#MySQL](https://img.shields.io/badge/MySQL-4479A1?logo=mysql&logoColor=white&style=flat-square) ![#PostgreSQL](https://img.shields.io/badge/PostgreSQL-336791?logo=postgresql&logoColor=white&style=flat-square) ![#SQLite](https://img.shields.io/badge/SQLite-003B57?logo=sqlite&logoColor=white&style=flat-square) ![#Docker](https://img.shields.io/badge/Docker-2496ED?logo=docker&logoColor=white&style=flat-square) ![#NGINX](https://img.shields.io/badge/NGINX-009639?logo=nginx&logoColor=white&style=flat-square) ![#Git](https://img.shields.io/badge/Git-F05032?logo=git&logoColor=white&style=flat-square) |
| **OS & Emulators** | ![#Debian](https://img.shields.io/badge/Debian-A81D33?logo=debian&logoColor=white&style=flat-square) ![#Ubuntu](https://img.shields.io/badge/Ubuntu-E95420?logo=ubuntu&logoColor=white&style=flat-square) ![#Windows](https://img.shields.io/badge/Windows-0078D6?logo=windows&logoColor=white&style=flat-square) ![#Android](https://img.shields.io/badge/Android-3DDC84?logo=android&logoColor=white&style=flat-square) ![#Termux](https://img.shields.io/badge/Termux-000?logo=termux&logoColor=white&style=flat-square) |
| **Software & Writing** | ![#VSCode](https://img.shields.io/badge/VS_Code/Codium-007ACC?logo=VSCodium&logoColor=white&style=flat-square) ![#NVim](https://img.shields.io/badge/NVim-57A143?logo=neovim&logoColor=white&style=flat-square) ![#Obsidian](https://img.shields.io/badge/Obsidian-483699?logo=obsidian&logoColor=white&style=flat-square) ![#Blogger](https://img.shields.io/badge/Blogger-FF5722?logo=blogger&logoColor=fff&style=flat) ![#Inkscape](https://img.shields.io/badge/Inkscape-000?logo=inkscape&logoColor=white&style=flat-square) |

> *Intereses: Inteligencia Artificial, Código Abierto y Ciberseguridad.*
...
¡Me encantaría ayudarte a darle vida a tus ideas! 🚀
Escríbeme directamente por **Instagram** o envíame un **correo** para que hagamos que las cosas sucedan.

<p align="center">
  <a href="mailto:alexrios1322+directmessage@proton.me">
    <img src="https://img.shields.io/badge/Proton%20Mail-6D4AFF?style=for-the-badge&logo=proton&logoColor=white" alt="Email">
  </a>
  <a href="https://instagram.com/devalexrios">
    <img src="https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white" alt="Instagram">
  </a>
</p>

<p align="center">¡Cuéntame qué tienes en mente y construyamos algo genial! 😀</p>
